...
class ConfigManager:
    ...
    def _create_default_config(self):
        return {
            "system": {
                ...
                "session_manager": {"session_timeout_minutes": 5, "max_sessions": 100}
            }
        }
    ...
    def get_config(self, module=None, key=None):
        try:
    ...
    async def update_config(self, module, key, value):
        try:
    ...
    def register_config_change_callback(self, module, callback):
    ...
    async def _notify_module_config_change(self, module, config_data):
