...
# -*- coding: utf-8 -*-
"""
image_manager.py - 图片管理模块 (纯异步并发版本)
"""
...
class ImageManager:
    ...
    async def initialize(self):
        ...
        max_concurrent = self.config.get("concurrency", {}).get("max_concurrent", 8)
    ...
    async def _download_and_encode_image(self, chat_id: str, url: str, image_id: str) -> Dict[str, Any]:
        try:
            ...
            base64_data = self._encode_to_base64(image_data, mime_type)
    ...
    def _encode_to_base64(self, image_data: bytes, mime_type: str) -> str:
        try:
    ...
    async def get_cache_status(self) -> Dict[str, Any]:
        async with self.lock:
            status = {
                ...
                "cache_by_chat": {},
                "concurrent_limits": {
                    "max_concurrent": self.download_semaphore._value if self.download_semaphore else 0
                }
            }
